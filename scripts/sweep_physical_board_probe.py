...
DEFAULT_EXPERIMENTS: tuple[Experiment, ...] = (
    ...
    Experiment(
        name="dino_topdown_aug_weighted_real128",
        args=(
            "--encoder-type",
            "dinov2",
            "--input-size",
        ...
        description="DINO with pseudo-real STL boards mixed into training.",
    ),
    Experiment(
        name="dino_topdown_aug_weighted_real556",
        args=(
            "--encoder-type",
            "dinov2",
            "--input-size",
        ...
        description="DINO with the full current pseudo-real STL board set mixed in.",
    ),
    Experiment(
        name="dino_topdown_aug_weighted_real556_seed0",
        args=(
            "--seed",
            "0",
            "--encoder-type",
        ...
        description="DINO pseudo-real mixed run showing the better seed-0 basin.",
    ),
    Experiment(
        name="dino_topdown_aug_weighted_real556_seed3",
        args=(
            "--seed",
            "3",
            "--encoder-type",
        ...
        description="DINO pseudo-real mixed run showing the better seed-3 basin.",
    ),
    Experiment(
        name="dino_topdown_transformer_real658_layers8_10_11",
        args=(
            "--seed",
            "3",
            "--encoder-type",
            "dinov2",
            "--dino-feature-layer-indices",
            "8,10,11",
            "--head-type",
            "transformer",
            "--transformer-layers",
        ...
        description="Multi-layer DINO transformer head on corrected pseudo-real boards.",
    ),
    Experiment(
        name="dino_topdown_posmlp_real658_layers8_10_11_rw4",
        args=(
            "--seed",
            "0",
            "--encoder-type",
        ...
        description="Multi-layer DINO positional MLP head on corrected pseudo-real boards.",
    ),
)
...
def result_row(
    ...
    return {
        ...
        "real_train_positions": str(metrics.get("real_train_positions", 0)),
