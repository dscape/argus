...
const tools = [
  ...
  },
  {
    ...
    description:
      "Upload a .pt training clip to inspect frames, move sequences, tensor shapes, and validate game replay.",
  },
  {
    href: "/calibration",
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-6">
        Visual tools for the Argus overlay pipeline. Select a tool to get
        started.
      </p>
