...
export default function PhysicalAnnotationIndexPage() {
  ...
  if (clips.length === 0) {
    return <div className="text-sm text-muted-foreground">No clips found in data/argus/train_real.</div>;
  }

  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">{clips.length} clips in <code>data/argus/train_real</code></p>
